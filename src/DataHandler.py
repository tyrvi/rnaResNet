...
def getCytofMMDDataFromCsv(sample1Path, sample1LabelsPath, sample2Path, sample2LabelsPath, iEqualizeMixtureCoeffs):
    ...
    target, target_test, targetLabels_train, targetLabels_test = train_test_split(sample1, sample1Labels, test_size=0.3)
    source, source_test, sourceLabels, sourceLabels_test = train_test_split(sample2, sample2Labels, test_size=0.3)
